...
?>
  ...
  <div id="page-wrapper"><div id="page">
    ...
    <div id="footer"><div class="section">
      ...
      <div id="social-media">
        <a href="https://www.facebook.com/PhotographyByDerek"><img src="<?php echo $GLOBALS['base_url'].'/'.drupal_get_path('theme', 'photographybyderek_blog'); ?>/images/facebook-icon.png" alt="photography by derek facebook page" /></a>
